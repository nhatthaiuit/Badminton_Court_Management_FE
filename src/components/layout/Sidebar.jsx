...
const Sidebar = ({ isMobileMenuOpen, setIsMobileMenuOpen }) => {
  ...
  return (
    <>
      ...
      {/* Logo Area */}
      <div className="h-16 sm:h-20 flex items-center px-4 sm:px-6 border-b border-gray-800 font-bold tracking-wider">
        <div className="flex items-center gap-3">
          <div className="bg-white rounded-full p-1 shadow-sm">
            <img src="/logo2.png" alt="BCMS Logo" className="h-10 w-10 sm:h-12 sm:w-12 object-contain" />
          </div>
          <span className="text-xl sm:text-2xl text-blue-400">BCMS</span>
        </div>
      </div>
