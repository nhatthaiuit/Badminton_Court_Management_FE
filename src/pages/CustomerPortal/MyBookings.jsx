        ...
        {bookings.length === 0 ? (
          ...
          bookings.map((booking) => (
            <div 
              ...
              className="group bg-white rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-xl border border-gray-300 flex flex-col sm:flex-row sm:items-center justify-between gap-6 transition-all duration-300 hover:-translate-y-1 cursor-pointer"
            >
